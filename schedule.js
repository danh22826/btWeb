...
const MOVIES = [
  {
    ...
    poster: "/New folder/conan.jpg",
    start: "30/10/2025",
    end: "02/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  {
    id: "lord",
    title: "Lord of Mysteries",
    poster: "New folder/lotm.jpg",
    start: "30/10/2025",
    end: "04/11/2025",
    times: ["08:30", "12:45", "17:00", "20:15"],
  },
  {
    id: "grandma",
    title: "CỤC VÀNG CỦA BÀ",
    poster: "/New folder/grandma.jpg",
    start: "30/10/2025",
    end: "08/11/2025",
    times: ["09:00", "13:30", "18:00", "22:00"],
  },
  {
    id: "GiaiMa",
    title: "CẢI MÃ",
    poster: "/New folder/caima.jpg",
    start: "30/10/2025",
    end: "10/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  {
    id: "MucSu",
    title: "MỤC SƯ, THẦY ĐỒ VÀ CON QUỶ ÂM TRÌ",
    poster: "/New folder/thaymuc.jpg",
    start: "30/10/2025",
    end: "07/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  ...
  },
  {
    id: "OPM",
    title: "One PUNCH MAN",
    poster: "/New folder/onepunch.jpg",
    start: "30/10/2025",
    end: "10/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  ...
  {
    id: "ThayCung",
    title: "CHÚ THUẬT HỒI CHIẾN: THE MOVIE",
    poster: "New folder/jjk.jpg",
    start: "30/10/2025",
    end: "03/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  {
    ...
    poster: "New folder/chainsaw.jpg",
    start: "30/10/2025",
    end: "02/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  ...
  },
  {
    ...
    poster: "/New folder/godzilla.jpg",
    start: "03/11/2025",
    end: "12/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  {
    ...
    poster: "/New folder/zooTopia.jpg",
    start: "02/11/2025",
    end: "13/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  ...
  },
  {
    ...
    poster: "/New folder/spongbob.jpg",
    start: "06/11/2025",
    end: "13/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  ...
  {
    id: "assasin",
    title: "SÁT THỦ LƯỠI KÉO",
    poster: "/New folder/sisor.jpg",
    start: "02/11/2025",
    end: "10/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
  {
    id: "NguHanh",
    title: "VỤ SƠN NGŨ HÀNH",
    poster: "/New folder/6hanh.jpg",
    start: "03/11/2025",
    end: "15/11/2025",
    times: ["09:00", "13:30", "18:00", "21:00"],
  },
...
function renderMoviesForDate(date) {
  ...
  const matches = MOVIES.filter((m) =>
    isBetween(date, parseDMY(m.start), parseDMY(m.end))
  );
  if (!matches.length) {
    moviesList.innerHTML =
      '<div class="no-data card">Không có suất chiếu cho ngày này.</div>';
    return;
  }
  matches.forEach((m) => {
...
function buildDateStrip() {
  DATES.forEach((d, i) => {
    ...
    btn.innerHTML = `<span>${String(d.getDate()).padStart(2, "0")}/${String(
      d.getMonth() + 1
    ).padStart(2, "0")}</span>`;
